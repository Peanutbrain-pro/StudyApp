...
///
/// Regenerate using "dart forui theme create --preset acbbbb".
///
...
FThemeData getLightTheme({String? fontFamily}) {
...
FThemeData getDarkTheme({String? fontFamily}) {
  // Change this to false to use the desktop variant of this theme.
  const touch = false;
...
FThemeData get lightTheme => getLightTheme();
FThemeData get darkTheme => getDarkTheme();
